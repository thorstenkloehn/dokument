...
```text
  [ 1. Installation & CLI-Auth ]
                 │
                 ▼
  [ 2. Projektsystem: claude init, CLAUDE.md, Skills, Subagenten, Hooks & MCP ]
                 │
                 ▼
  [ 3. Subagenten-Delegation & Architektur-Planung ]
                 │
                 ▼
  [ 4. Autonomer TDD-Loop & Coding ]
                 │
                 ▼
  [ 5. Multi-File Edits & Debugging ]
                 │
                 ▼
  [ 6. Linter, Quality & Security Audits ]
                 │
                 ▼
  [ 7. Dokumentation & Git Integration ]
                 │
                 ▼
  [ 8. Production Build, Packaging & Release ]
                 │
                 ▼
  [ 9. Skalierung: Permissions, Plugins, Headless-CI & Team-Rollout ]
```
...
| **Auto Memory** | `~/.claude/projects/<project>/memory/` | Markdown | Von Claude selbst geschriebene Lernpunkte (siehe [2.7](#27-auto-memory--selbstständiges-lernen)) |
