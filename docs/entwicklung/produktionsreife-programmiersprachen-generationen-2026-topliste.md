...
- [Produktionsreife Programmiersprachen für Wissenssysteme nach Generation (Top 7)](../wissen/dokumentation/produktionsreife-wissenssystem-programmiersprachen-generationen-2026-topliste.md) — dritte Domänen-Vertiefung (Wiki/PKM/Docs); dort trifft jede Generation ab 2, nur Perl fällt
