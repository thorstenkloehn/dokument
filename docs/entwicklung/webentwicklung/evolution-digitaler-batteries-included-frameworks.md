...
- [Evolution und Architekturen digitaler Programmierparadigmen](../evolution-digitaler-programmierparadigmen.md) — Phoenix/Elixir aus Generation 5 dieses Artikels als konkrete Anwendung des Actor Model aus Generation 5 dort
- [Evolution und Architekturen digitaler Paketmanager](../system/evolution-digitaler-paketmanager.md) — Composer als Laravels Paketverwaltungs-Baustein aus Generation 2 dieses Artikels, dort als Generation 3 der Paketmanager-Zeitachse eingeordnet
