...
- [Evolution und Architekturen digitaler Programmierparadigmen](../evolution-digitaler-programmierparadigmen.md) — Signals/Reaktivitätsmodell aus den Klassifikationskriterien dieses Artikels als konkrete Anwendung des reaktiven Paradigmas (Generation 6 dort)
