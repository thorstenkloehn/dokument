...
- **Generation 6 (KI-nativ)**: zu jung und häufig an einen einzelnen Hosting-Anbieter gekoppelt — die Reifezeit- und Lizenzfilter greifen doppelt. Eigene Betrachtung: [Produktionsreife Open-Source-KI-native Web-Frameworks nach Generation](produktionsreife-ki-native-webframeworks-generationen-2026-topliste.md).
...
- [Produktionsreife Open-Source-Batteries-Included-Web-Frameworks nach Generation (Top 5)](produktionsreife-batteries-included-frameworks-generationen-2026-topliste.md) — dasselbe Sieb, enger auf die Vollausstattungs-Philosophie; kein JavaScript-Vertreter besteht
...
- [Produktionsreife Open-Source-Web-Frameworks mit vollständigem pgvector-Support nach Generation (Top 2)](produktionsreife-pgvector-webframeworks-generationen-2026-topliste.md) — der Speicherfilter auf „vollständige pgvector-Bindung" verengt; nur Django und Rails bestehen, weil ihre Bindung 2021 die Fünf-Jahres-Marke nahm
