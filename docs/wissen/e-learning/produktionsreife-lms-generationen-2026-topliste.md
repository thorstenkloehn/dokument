...
- [Produktionsreife interoperable LMS-Bausteine nach Generation (kein Treffer)](produktionsreife-interoperable-lms-generationen-2026-topliste.md) — dasselbe Sieb für die Interoperabilitäts-Linie (Generation 3); die Standards sind reif, aber keine betreibbaren Systeme
- [Produktionsreife KI-adaptive Lernplattformen nach Generation (kein Treffer)](produktionsreife-ki-adaptive-lernplattformen-generationen-2026-topliste.md) — dasselbe Sieb für die KI-adaptive Linie (Generation 4); fast vollständig proprietäres SaaS, einziger quelloffener Pfad ist Moodle mit KI-Plugins
- [Produktionsreife agentische Tutor-Ökosysteme nach Generation (kein Treffer)](produktionsreife-agentische-tutor-oekosysteme-generationen-2026-topliste.md) — dasselbe Sieb für die agentische Linie (Generation 5); Architektur erst seit 2023, klarster „kein Treffer" der Familie
