...
- [Evolution und Architekturen digitaler Programmierparadigmen](../../entwicklung/evolution-digitaler-programmierparadigmen.md) — Clojure und Erlang/Elixir aus diesem Artikel als Vertreter des funktionalen (Generation 4) bzw. nebenläufigen Paradigmas (Generation 5) dort
