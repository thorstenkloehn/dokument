...
- [Produktionsreife Open-Source-CMS mit vollständigem pgvector-Support nach Generation (kein Treffer)](produktionsreife-pgvector-cms-generationen-2026-topliste.md) — derselbe Speicherfilter auf „vollständige pgvector-Anbindung" verengt; die CMS sind reif, die pgvector-Module noch Alpha
