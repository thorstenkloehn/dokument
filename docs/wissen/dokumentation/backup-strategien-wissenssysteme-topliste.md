...
- [Enterprise-Wissenssystem Sicherheit & PII-freie Backups](../../entwicklung/infrastruktur/sicherheit/enterprise-wissenssystem-sicherheit-postgresql-topliste.md) – Sicherheits- und Reifegrad-Vergleich datenbankneutraler Backups (z. B. backup.xml)
