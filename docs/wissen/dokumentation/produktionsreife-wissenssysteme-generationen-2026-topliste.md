...
- [Produktionsreife Open-Source-Wissenssysteme mit vollständigem pgvector-Support nach Generation (Top 2)](produktionsreife-pgvector-wissenssysteme-generationen-2026-topliste.md) — der Speicherfilter auf „muss pgvector nutzen" verengt: nur Haystack und pgvector bestehen, kein integriertes Produkt
