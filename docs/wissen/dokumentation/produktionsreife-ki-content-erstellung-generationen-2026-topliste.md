...
- [Produktionsreife Open-Source-CMS mit vollständigem pgvector-Support nach Generation (kein Treffer)](produktionsreife-pgvector-cms-generationen-2026-topliste.md) — dieselbe „reifes CMS + zu junges Modul"-Struktur für die pgvector-gestützte semantische Suche
